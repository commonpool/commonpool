...
func (us *UserStore) getByKey(session neo4j.Session, key keys.UserKey) (*user.User, error) {
...
func (us *UserStore) getByKeys(session neo4j.Session, key *keys.UserKeys) (*user.Users, error) {
