...
func (c ChatService) SubscribeToChannel(ctx context.Context, channelSubscriptionKey chat.ChannelSubscriptionKey, name string) (*chat.ChannelSubscription, error) {
