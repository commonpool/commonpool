...
func (t TransactionService) ResourceWasBorrowed(groupKey keys.GroupKey, resourceKey keys.ResourceKey, recipient *keys.Target, expectedDuration time.Duration) (*transaction2.Entry, error) {
	entry := &transaction2.Entry{
		Key:         keys.NewTransactionEntryKey(uuid.NewV4()),
...
func (t TransactionService) ResourceWasReturned(groupKey keys.GroupKey, resourceKey keys.ResourceKey, recipient *keys.Target, actualDuration time.Duration) (*transaction2.Entry, error) {
	entry := &transaction2.Entry{
		Key:         keys.NewTransactionEntryKey(uuid.NewV4()),
...
func (t TransactionService) ResourceWasTaken(groupKey keys.GroupKey, resourceKey keys.ResourceKey, recipient *keys.Target) (*transaction2.Entry, error) {
	entry := &transaction2.Entry{
		Key:         keys.NewTransactionEntryKey(uuid.NewV4()),
...
func (t TransactionService) TimeCreditsExchanged(groupKey keys.GroupKey, from *keys.Target, recipient *keys.Target, amount time.Duration) (*transaction2.Entry, error) {
	entry := &transaction2.Entry{
		Key:         keys.NewTransactionEntryKey(uuid.NewV4()),
