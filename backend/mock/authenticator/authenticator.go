...
// Ensure, that AuthenticatorMock does implement authenticator.Authenticator.
// If this is not the case, regenerate this file with moq.
var _ authenticator.Authenticator = &AuthenticatorMock{}

// AuthenticatorMock is a mock implementation of authenticator.Authenticator.
//
//     func TestSomethingThatUsesAuthenticator(t *testing.T) {
//
//         // make and configure a mocked authenticator.Authenticator
...
//             },
//             RegisterFunc: func(c *echo.Group)  {
// 	               panic("mock out the Register method")
//             },
//         }
//
//         // use mockedAuthenticator in code that requires authenticator.Authenticator
...
func (mock *AuthenticatorMock) Register(c *echo.Group) {
	if mock.RegisterFunc == nil {
		panic("AuthenticatorMock.RegisterFunc: method is nil but Authenticator.Register was just called")
	}
	callInfo := struct {
		C *echo.Group
	}{
...
// Check the length with:
//     len(mockedAuthenticator.RegisterCalls())
func (mock *AuthenticatorMock) RegisterCalls() []struct {
	C *echo.Group
} {
	var calls []struct {
		C *echo.Group
