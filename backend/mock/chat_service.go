...
func (mock *ChatService) CreateChannel(ctx context.Context, channelKey model.ChannelKey, channelType chat.ChannelType) (*chat.Channel, error) {
...
func (mock *ChatService) GetChannel(ctx context.Context, channelKey model.ChannelKey) (*chat.Channel, error) {
...
func (mock *ChatService) GetMessage(ctx context.Context, messageKey model.MessageKey) (*chat.Message, error) {
...
func (mock *ChatService) SubscribeToChannel(ctx context.Context, channelSubscriptionKey model.ChannelSubscriptionKey, name string) (*chat.ChannelSubscription, error) {
