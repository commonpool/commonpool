...
// Ensure, that ChatService does implement service.Service.
// If this is not the case, regenerate this file with moq.
var _ service.Service = &ChatService{}

// ChatService is a mock implementation of service.Service.
//
...
//             },
//             DeleteGroupChannelFunc: func(ctx context.Context, request *service.DeleteGroupChannel) (*service.DeleteGroupChannelResponse, error) {
...
//             },
//             GetConversationChannelKeyFunc: func(ctx context.Context, participants *keys.UserKeys) (keys.ChannelKey, error) {
// 	               panic("mock out the GetConversationChannelKey method")
//             },
...
//             },
//             GetMessagesFunc: func(ctx context.Context, channel keys.ChannelKey, before time.Time, take int) (*store.GetMessagesResponse, error) {
...
//             },
//             SendConversationMessageFunc: func(ctx context.Context, request *service.SendConversationMessage) (*service.SendConversationMessageResponse, error) {
// 	               panic("mock out the SendConversationMessage method")
//             },
//             SendGroupMessageFunc: func(ctx context.Context, request *service.SendGroupMessage) (*service.SendGroupMessageResponse, error) {
...
type ChatService struct {
	...
	// GetConversationChannelKeyFunc mocks the GetConversationChannelKey method.
	GetConversationChannelKeyFunc func(ctx context.Context, participants *keys.UserKeys) (keys.ChannelKey, error)
	...
	calls struct {
		...
		DeleteGroupChannel []struct {
			...
			Request *service.DeleteGroupChannel
		}
		...
		// GetConversationChannelKey holds details about calls to the GetConversationChannelKey method.
		GetConversationChannelKey []struct {
			// Ctx is the ctx argument value.
			Ctx context.Context
			// Participants is the participants argument value.
			Participants *keys.UserKeys
		}
		...
		SendConversationMessage []struct {
			...
			Ctx context.Context
			// Request is the request argument value.
			Request *service.SendConversationMessage
		}
		...
		SendGroupMessage []struct {
			...
			Ctx context.Context
			// Request is the request argument value.
			Request *service.SendGroupMessage
		}
	...
	lockGetConversationChannelKey sync.RWMutex
...
func (mock *ChatService) DeleteGroupChannel(ctx context.Context, request *service.DeleteGroupChannel) (*service.DeleteGroupChannelResponse, error) {
...
// GetConversationChannelKey calls GetConversationChannelKeyFunc.
func (mock *ChatService) GetConversationChannelKey(ctx context.Context, participants *keys.UserKeys) (keys.ChannelKey, error) {
	if mock.GetConversationChannelKeyFunc == nil {
		panic("ChatService.GetConversationChannelKeyFunc: method is nil but Service.GetConversationChannelKey was just called")
	}
	callInfo := struct {
		Ctx          context.Context
		Participants *keys.UserKeys
	...
	mock.lockGetConversationChannelKey.Lock()
	mock.calls.GetConversationChannelKey = append(mock.calls.GetConversationChannelKey, callInfo)
	mock.lockGetConversationChannelKey.Unlock()
	return mock.GetConversationChannelKeyFunc(ctx, participants)
}

// GetConversationChannelKeyCalls gets all the calls that were made to GetConversationChannelKey.
// Check the length with:
//     len(mockedService.GetConversationChannelKeyCalls())
func (mock *ChatService) GetConversationChannelKeyCalls() []struct {
	Ctx          context.Context
	Participants *keys.UserKeys
} {
	var calls []struct {
	...
	mock.lockGetConversationChannelKey.RLock()
	calls = mock.calls.GetConversationChannelKey
	mock.lockGetConversationChannelKey.RUnlock()
	return calls
}
...
func (mock *ChatService) GetMessages(ctx context.Context, channel keys.ChannelKey, before time.Time, take int) (*store.GetMessagesResponse, error) {
...
func (mock *ChatService) SendConversationMessage(ctx context.Context, request *service.SendConversationMessage) (*service.SendConversationMessageResponse, error) {
...
func (mock *ChatService) SendGroupMessage(ctx context.Context, request *service.SendGroupMessage) (*service.SendGroupMessageResponse, error) {
