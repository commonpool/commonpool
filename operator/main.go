...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "5de20c19.commonpool.net",
	})
	if err != nil {
	...
	if err = (&controllers.CommonpoolInstallationReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("CommonpoolInstallation"),
